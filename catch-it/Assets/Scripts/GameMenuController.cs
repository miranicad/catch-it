...
public class GameMenuController : MonoBehaviour
{
    ...
    public void ShowLevelStart(string levelSummary = "")
    {
        var levelSummaryText = levelStartPanel.GetComponentsInChildren<TMP_Text>().FirstOrDefault(t => t.gameObject.name == "LevelSummary");
        if (levelSummaryText != null)
        {
            levelSummaryText.text = levelSummary;
        }

        ShowOnly(levelStartPanel);
    }
